...
'Clean Code','My main guideline during development is the quality of the code following the best practices in the market.','Updated Tools','I have as part of the job the implementation of new features and technologies. that will add to the project','Optimized Interfaces','I work with the faithful implementation of interfaces striving for the best user experience to meet the expectations of each project','Latest Projects']
